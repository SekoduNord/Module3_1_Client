 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://servs/", wsdlLocation = "http://localhost:9090/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://servs/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/Calculator?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://servs/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servs/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
